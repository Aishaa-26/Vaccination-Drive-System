...
import client.*;
import client.QueueImplementation.QueueHead;
...
public class venue1 {
	...
	public void VaccinationAtVenue1() {
		...
		QueueImplementation m = new QueueImplementation();
		...
		do {
			while (flag == 0) {
				...
				case 3:
					...
					while (c1 == 1) {
						for (int i = 1; i <= 36; i++) {
							...
							if (age >= 55) {
								if (Slot1.count <= 5) {
									QueueImplementation.Enqueue(Slot1, age, adhar, s3, rno);
									rno++;
									Slot1.count++;
									System.out.println();
								...
								if (Slot2.count <= 5) {
									QueueImplementation.Enqueue(Slot2, age, adhar, s3, rno);
									rno++;
									Slot2.count++;
									System.out.println();
							...
							{
								if (Slot3.count <= 5) {
									QueueImplementation.Enqueue(Slot3, age, adhar, s3, rno);
									rno++;
									Slot3.count++;
									System.out.println();
				...
				case 4:
					System.out.println();
					if (QueueImplementation.IsQueueEmpty(Slot1) && QueueImplementation.IsQueueEmpty(Slot2)
							&& QueueImplementation.IsQueueEmpty(Slot3)) {
				...
				case 5:
					...
					if (QueueImplementation.IsQueueEmpty(Slot1) && QueueImplementation.IsQueueEmpty(Slot2)
						...
						System.out.println(
								"----------------------------------------------------------------------------------------------------------------------------------");
						if (QueueImplementation.IsQueueEmpty(Slot1)) {
							...
							do {
								if ((Slot1.count >= 1)) {
									...
									QueueImplementation.DisplayQueue(Slot1);
									System.out.println(" ");
									QueueImplementation.Dequeue(Slot1);
									System.out.println(" ");
						...
						System.out.println(
								"----------------------------------------------------------------------------------------------------------------------------------");
						if (QueueImplementation.IsQueueEmpty(Slot2)) {
							System.out.println(" NO ONE IS THERE FOR VACCINATION ");
						} else {
							while (Slot2.count != 0) {
								...
								if ((Slot2.count >= 1)) {
									...
									QueueImplementation.DisplayQueue(Slot2);
									System.out.println(" ");
									QueueImplementation.Dequeue(Slot2);
									System.out.println(" ");
						...
						System.out.println(
								"----------------------------------------------------------------------------------------------------------------------------------");
						if (QueueImplementation.IsQueueEmpty(Slot3)) {
							System.out.println(" NO ONE IS THERE FOR VACCINATION ");
						} else {
							do {
								if ((Slot3.count >= 1)) {
									...
									QueueImplementation.DisplayQueue(Slot3);
									System.out.println(" ");
									QueueImplementation.Dequeue(Slot3);
									System.out.println(" ");
									System.out.println("  " + rno + " YOU GOT VACCINATED SUCCESFULLY !!!!");
									System.out.println(
											"  Please download your certificate from site : www.cowin.com !!!!");
